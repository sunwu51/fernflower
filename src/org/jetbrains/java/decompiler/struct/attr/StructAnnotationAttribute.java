  ...
  public static Exprent parseAnnotationElement(DataInputStream data, ConstantPool pool) throws IOException {
    ...
    switch (tag) {
      ...
      default: {
        ...
        switch (tag) {
          case 'B':
            result = new ConstExprent(VarType.VARTYPE_BYTE, cn.value, null);
            break;
          case 'C':
            result = new ConstExprent(VarType.VARTYPE_CHAR, cn.value, null);
            break;
          case 'D':
            result = new ConstExprent(VarType.VARTYPE_DOUBLE, cn.value, null);
            break;
          case 'F':
            result = new ConstExprent(VarType.VARTYPE_FLOAT, cn.value, null);
            break;
          case 'I':
            result = new ConstExprent(VarType.VARTYPE_INT, cn.value, null);
            break;
          case 'J':
            result = new ConstExprent(VarType.VARTYPE_LONG, cn.value, null);
            break;
          case 'S':
            result = new ConstExprent(VarType.VARTYPE_SHORT, cn.value, null);
            break;
          case 'Z':
            result = new ConstExprent(VarType.VARTYPE_BOOLEAN, cn.value, null);
            break;
          case 's':
            result = new ConstExprent(VarType.VARTYPE_STRING, cn.value, null);
            break;
          default:
